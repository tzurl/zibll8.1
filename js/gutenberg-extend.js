(function ($, wp, window) {
    $(document).ready(function () {
        ...
        icon.iframeseries = el(
            'svg',
            icon_args(),
            el('path', {
                d: 'm 662.88377,441.87421 a 42.666667,42.666667 0 0 1 -72.87235,-31.63569 l 7.28782,-180.63176 a 43.235556,43.235556 0 0 1 42.55618,-42.72389 42.666667,42.666667 0 0 1 42.72388,42.55617 l -7.2815,183.84988 a 40.96,40.96 0 0 1 -12.41403,28.58529 z',
                fill: icon_color,
            }),
            el('path', {
                d: 'm 843.88852,434.27746 a 42.097778,42.097778 0 0 1 -28.53625,12.52636 l -181.00475,7.59675 a 42.666667,42.666667 0 0 1 -4.18877,-84.46761 l 180.60327,-7.19369 a 42.666667,42.666667 0 0 1 32.32355,72.34431 z',
                fill: icon_color,
            }),
            el('path', {
                d: 'M 873.65726,230.27007 662.88377,441.87421 a 42.666668,42.666668 0 0 1 -60.45832,-60.221 L 813.19894,170.04908 a 42.666667,42.666667 0 0 1 60.45832,60.22099 z',
                fill: icon_color,
            }),
            el('path', {
                d: 'm 922.2479,554.42362 0.64665,328.81714 a 42.097778,42.097778 0 0 1 -42.58268,42.75049 l -735.00302,1.44546 a 42.097778,42.097778 0 0 1 -42.75049,-42.58267 l -1.17919,-599.60773 a 42.666667,42.666667 0 0 1 42.58268,-42.75049 l 302.6483,-0.59519 a 42.666667,42.666667 0 1 1 0.16782,85.33316 l -259.98172,0.51129 1.00689,511.99901 649.66986,-1.27765 -0.55939,-284.44389 a 42.666667,42.666667 0 1 1 85.33317,-0.16782 z',
                fill: icon_color,
            }),
            el('path', {
                d: 'm 705.18337,682.28186 a 42.097778,42.097778 0 0 1 -42.58268,42.75049 l -341.33267,0.67126 a 42.666667,42.666667 0 0 1 -0.16782,-85.33316 l 341.33268,-0.67127 a 42.666667,42.666667 0 0 1 42.75049,42.58268 z M 534.15231,497.16007 a 42.097778,42.097778 0 0 1 -42.58268,42.75049 L 320.9033,540.2462 a 42.666667,42.666667 0 1 1 -0.16782,-85.33317 l 170.66634,-0.33564 a 42.666667,42.666667 0 0 1 42.75049,42.58268 z',
                fill: icon_color,
            }),
        );
        ...
        rB('zibllblock/dplayerfeatured', {
            ...
            transforms: {
                to: [
                    ...
                    {
                        type: 'block',
                        blocks: ['zibllblock/iframeseries'],
                        transform: function (e) {
                            var attr = {
                                lists: e.featured,
                            };
                            return createBlock('zibllblock/iframeseries', attr);
                        },
                    },
                ],
            },
            edit: function (props) {
                ...
                var featured = at.featured.length
                    ? at.featured
                    : [
                          {
                              text: '',
                            ...
                            (!url || isS) &&
                                el(
                                    ...
                                    el(
                                        'div',
                                        {
                                            className: 'opacity8 iframe-label',
                                        },
                                        '请输入需要嵌入的链接，或者直接粘贴iframe嵌入代码以自动提取链接（如需插入多个嵌入，请使用“zibll剧集嵌入”）'
                                    ),
                                    el(
                                        'a',
                                        {
        ...
        //--------------------------------------------------------------------
        rB('zibllblock/iframeseries', {
            title: show_title('剧集嵌入'),
            icon: icon.iframeseries,
            supports: {
                className: false, //保存时候不自动添加根class
                color: false, //不为块添加背景和颜色设置
            },
            description: '在文章中嵌入多个其他在线内容可切换显示，通常用于嵌入其它网站的视频播放器或音乐播放器，也可以嵌入其它任意在线内容',
            category: 'zibll_block_cat',
            attributes: {
                lists: {
                    type: 'array',
                    source: 'query',
                    selector: '.switch-iframe',
                    default: [
                        {
                            text: '',
                            url: '',
                ...
                to: [
                    {
                        ...
                        transform: function (e) {
                            ...
                            return createBlock('zibllblock/iframe', attr);
                        },
                    },
                    {
                        type: 'block',
            ...
            edit: function (props) {
                var at = props.attributes,
                        ...
                        return el(
                            ...
                            el(
                                ...
                                el(
                                    ...
                                    el(TextControl, {
                                        ...
                                        onChange: function (e) {
                                            lists[_key].text = e;
                                            sa({
                                                lists: _toConsumableArray(lists),
                                            });
                                        },
                                        value: lists[_key].text,
                                        placeholder: '请输入剧集标题，默认为：第' + (_key + 1) + '集',
                                    }),
                                    [
                                        lists.length > 2 &&
                                ...
                                el(TextControl, {
                                    ...
                                    value: lists[_key].url,
                                    placeholder: '请输入需要嵌入的链接，或者直接粘贴iframe嵌入代码以自动提取链接',
                                }),
                            )
                        );
                    };
                    ...
                    var add = function () {
                        ...
                        sa({
                            lists: [].concat(_toConsumableArray(lists), add),
                        });
                    };
                    var remove = function (_key) {
                        if (lists.length < 3) {
                ...
                return el(
                    ...
                    el(
                        ...
                        el(
                            ...
                            '嵌入多剧集，支持其他网站的视频播放器或音乐播放器，也可为其它任意在线内容，如果仅需单个嵌入请使用“Zibll超级嵌入”模块'
                        ),
            ...
            save: function (props) {
                ...
                return el(
                    'div',
                    {
                        className: 'mb20 iframe-series',
                    },
                    el(
                        'div',
                        {
                            className: 'wp-block-embed is-type-video',
                        },
                    el(
                        'div',
                        {
                            className: 'iframe-series-box',
                            style: {
                                'padding-bottom': aspect,
                            },
                        },
                    ...
                    el(
                        ...
                        lists.map(function (item, index) {
                            ...
                            return el(
                                'a',
                                {
                                    className: 'switch-iframe text-ellipsis' + (index == 1 ? ' active' : ''),
                                    'data-index': index,
                                    'iframe-url': item.url,
                                    title: item.text,
                                    href: 'javascript:;',
