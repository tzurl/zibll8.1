 ...
 * @LastEditTime: 2024-12-27 12:14:56
...
function zib_get_comments_action_list($comment, $depth)
{
    ...
    if (!$comment->comment_parent && zib_current_user_can('comment_set_topping', $comment)) {
...
//为置顶评论显示数据
function zib_comments_array_filter_topping($comments, $posts_id)
{
