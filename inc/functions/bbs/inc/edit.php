 ...
 * @LastEditTime: 2024-12-22 14:39:34
...
class zib_bbs_edit
{
    ...
    public static function term_select_lists_tab($type = 'topic', $in_id = 0)
    {
        ...
        return '<div class="plate-select-tab padding-w10 posts-' . $type . '-select"><div class="relative"><ul class="font-bold list-inline scroll-x no-scrollbar tab-nav-theme text-center">' . $tab_nav_lists . '</ul></div><div class="tab-content" for-group="' . $type . '">' . $tab_con . '</div></div>';
    }
    ...
    public static function plate_select_lists_tab($in_plate_id = 0, $class = '', $con_class = '')
    {
        ...
        return '<div class="plate-select-tab ' . $class . '"><div class="relative"><ul class="font-bold list-inline scroll-x no-scrollbar tab-nav-theme text-center">' . $tab_nav_lists . '</ul></div><div class="tab-content ' . $con_class . '" for-group="plate">' . $tab_con . '</div></div>';
    }
