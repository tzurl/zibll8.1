 ...
 * @LastEditTime: 2022-12-06 21:08:37
 */
class XH_Payment_Api
{
    ...
    public static function is_wechat_app()
    {
        ...
        return strripos($useragent, 'micromessenger') && !strripos($useragent, 'wxwork') && !strripos($useragent, 'WindowsWechat') && !strripos($useragent, 'MacWechat');
    }
}
